package com.base.common.exception.service;
/**
 *项目名：
 *创建时间：2016-6-18
 *创建人：Aobo
...
public class ServiceException extends RuntimeException{
	...
	/**
	 * 异常构造方法，msg为错误信息，
	 * 建议使用ServiceException(String msg,String errorCode)或
	 * ServiceException(String msg,String errorCode,Throwable cause)
	 * @param msg 错误信息
	 */
	 ...
	 * 异常构造方法，msg为错误信息,errorCode错误代码
	 * 建议使用本异常处理构造方法或
	 * ServiceException(String msg,String errorCode)
	 * @param msg 错误信息
	 * @param errorCode 错误代码
	 * @param cause 异常处理的超类，可以为任意类型的异常处理类
	 */
	 ...
	 */
	public ServiceException(String msg,String errorCode,String fieldName){
		super(msg);
		this.errorMessage = msg;
	 ...
	 * @param cause 异常处理的超类，可以为任意类型的异常处理类
	 */
	public ServiceException(String msg,String errorCode,String fieldName,Throwable cause){
		super(msg,cause);
		this.errorMessage = msg;
		this.fieldName = fieldName;
		this.errorCode = errorCode;
